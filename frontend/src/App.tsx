      ...
      <div className="min-h-screen bg-brand-light font-secondary text-brand-dark">
        ...
        <main className="container mx-auto px-4 py-8 max-w-7xl">
          <Routes>
              ...
              element={
                <div className="animate-fade-in-up">
                  <div className="mb-8 text-center">
                    <h2 className="text-3xl font-bold font-primary text-brand-dark mb-2">
            ...
            <Route
              path="*"
              element={<div className="p-20 text-center text-xl text-gray-500">Page introuvable (404)</div>}
            />
          </Routes>
        </main>
      </div>
