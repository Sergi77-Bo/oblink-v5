...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        // --- 1. MOCK DATA SYSTEM (Enterprise Version) ---
        const MOCK_MESSAGING = {
            conversations: [
                {
                    ...
                    lastMessage: 'Je suis disponible pour la mission.',
                    messages: [
                        { sender: 'them', text: 'Bonjour, je suis intéressé par votre offre.', time: '09:00' },
                        { sender: 'me', text: 'Bonjour Thomas, quand êtes-vous disponible ?', time: '09:15' },
                        { sender: 'them', text: 'Je suis disponible pour la mission dès lundi.', time: '09:30' }
                    ]
                },
                {
                    id: 'conv_e2',
                    ...
                    name: 'Sophie Martin',
                    initial: 'S',
                    avatarColor: 'bg-oblink-violet',
                    lastMessage: 'Merci pour l\'entretien.',
                    messages: [
                        { sender: 'me', text: 'Merci pour l\'entretien de ce matin.', time: 'Hier' },
                        { sender: 'them', text: 'Merci à vous, je reste à votre disposition.', time: 'Hier' }
                    ]
                }
            ],
            getConversations: function () {
                const stored = localStorage.getItem('oblink_mock_conversations_ent');
            ...
            saveMessage: function (contactId, text) {
                ...
                localStorage.setItem('oblink_mock_conversations_ent', JSON.stringify(convs));
                return conv;
            }
        };
        ...
        function bindConversationEvents() {
            document.querySelectorAll('.conversation-item').forEach(item => {
                item.addEventListener('click', function () {
                    ...
                    document.querySelectorAll('.conversation-item').forEach(c => c.classList.remove('bg-white', 'ring-2', 'ring-oblink-blue'));
                    this.classList.add('bg-white', 'ring-2', 'ring-oblink-blue'); // Blue for Enterprise
