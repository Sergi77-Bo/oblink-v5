...
// Register route with type parameter
app.get('/register', (c) => {
  const type = c.req.query('type')
  if (type === 'opticien') {
    return c.redirect('/register/opticien', 302)
  } else if (type === 'entreprise') {
    return c.redirect('/register/entreprise', 302)
  } else {
    return c.redirect('/inscription', 302)
  }
})
...
// Login route (alias for /connexion)
app.get('/login', (c) => {
...
app.get('/connexion', (c) => {
  return c.html(`
    ...
    <body class="bg-gradient-to-br from-slate-50 via-blue-50 to-violet-50 min-h-screen">
        ...
        <div class="max-w-md mx-auto px-4 py-32">
            <div class="text-center mb-8">
                <h1 class="text-4xl font-bold text-gray-800 mb-4">Connexion</h1>
                <p class="text-gray-600">Accédez à votre compte OBLINK</p>
            </div>
            ...
            <form class="glass-card p-8 space-y-6">
                ...
                <div>
                    ...
                    <input type="password" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-oblink-orange focus:border-transparent" required>
                </div>
                
                <div class="flex items-center justify-between text-sm">
                    <label class="flex items-center">
                        <input type="checkbox" class="w-4 h-4 text-oblink-orange border-gray-300 rounded focus:ring-oblink-orange">
                        <span class="ml-2 text-gray-700">Se souvenir de moi</span>
                    </label>
                    <a href="#" class="text-oblink-orange hover:underline">Mot de passe oublié ?</a>
                </div>
            ...
            <p class="text-center mt-6 text-gray-600">
                Pas encore inscrit ? <a href="/inscription" class="text-oblink-orange font-semibold hover:underline">Créer un compte</a>
            </p>
        </div>
    </body>
    </html>
...
// Inscription route (redirection vers le choix)
app.get('/inscription', (c) => {
  return c.html(`
    ...
    <head>
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>Inscription - OBLINK</title>
        <script src="https://cdn.tailwindcss.com"></script>
        <link href="https://cdn.jsdelivr.net/npm/@fortawesome/fontawesome-free@6.4.0/css/all.min.css" rel="stylesheet">
        <link href="/static/styles.css" rel="stylesheet">
    </head>
    <body class="bg-gradient-to-br from-slate-50 via-blue-50 to-violet-50 min-h-screen">
        ...
        <div class="max-w-4xl mx-auto px-4 py-32">
            <div class="text-center mb-16">
                <h1 class="text-5xl font-bold text-gray-800 mb-4">Rejoignez OBLINK</h1>
                <p class="text-xl text-gray-600">Choisissez votre profil</p>
            </div>
            
            <div class="grid md:grid-cols-2 gap-8">
                <!-- Opticien Card -->
                <a href="/register/opticien" class="group glass-card p-12 text-center hover:shadow-2xl transition transform hover:scale-105 border-2 border-transparent hover:border-oblink-orange">
                    <div class="text-6xl mb-6 text-oblink-orange">
                        <i class="fas fa-eye"></i>
                    </div>
                    <h2 class="text-3xl font-bold text-gray-800 mb-4">Opticien</h2>
                    <p class="text-gray-600 mb-6">
                        Je suis opticien freelance et je recherche des missions professionnelles
                    </p>
                    <div class="text-oblink-orange font-semibold group-hover:translate-x-2 transition-transform">
                        Je suis opticien <i class="fas fa-arrow-right ml-2"></i>
                    </div>
                </a>
                
                <!-- Entreprise Card -->
                <a href="/register/entreprise" class="group glass-card p-12 text-center hover:shadow-2xl transition transform hover:scale-105 border-2 border-transparent hover:border-oblink-violet">
                    <div class="text-6xl mb-6 text-oblink-violet">
                        <i class="fas fa-building"></i>
                    </div>
                    <h2 class="text-3xl font-bold text-gray-800 mb-4">Entreprise</h2>
                    <p class="text-gray-600 mb-6">
                        Je suis une entreprise optique et je recherche des profils qualifiés
                    </p>
                    <div class="text-oblink-violet font-semibold group-hover:translate-x-2 transition-transform">
                        Je suis une entreprise <i class="fas fa-arrow-right ml-2"></i>
                    </div>
                </a>
            </div>
            
            <p class="text-center mt-12 text-gray-600">
                Déjà inscrit ? <a href="/connexion" class="text-oblink-orange font-semibold hover:underline">Se connecter</a>
            </p>
        </div>
    </body>
    </html>
...
app.get('/cgu', (c) => {
  return c.html(`
    ...
    <head>
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>Conditions Générales d'Utilisation - OBLINK</title>
        <script src="https://cdn.tailwindcss.com"></script>
        <link href="https://cdn.jsdelivr.net/npm/@fortawesome/fontawesome-free@6.4.0/css/all.min.css" rel="stylesheet">
        <link href="/static/styles.css" rel="stylesheet">
    </head>
    <body class="bg-gradient-to-br from-slate-50 via-blue-50 to-violet-50">
        ...
        <div class="max-w-4xl mx-auto px-4 py-32">
            <h1 class="text-5xl font-bold text-gray-800 mb-8">Conditions Générales d'Utilisation</h1>
            
            <div class="prose prose-lg max-w-none">
                <div class="glass-card p-8 space-y-6">
                    <section>
                        <h2 class="text-2xl font-bold text-gray-800 mb-4">1. Définitions</h2>
                        <p class="text-gray-700">OBLINK est une plateforme de mise en relation entre opticiens freelance et entreprises optiques. Les termes "Utilisateur", "Vous" ou "Votre" désignent toute personne accédant à la plateforme.</p>
                    </section>
                    
                    <section>
                        <h2 class="text-2xl font-bold text-gray-800 mb-4">2. Conditions d'Utilisation</h2>
                        <p class="text-gray-700">En utilisant OBLINK, vous acceptez de respecter l'ensemble de ces conditions. Vous vous engagez à ne pas utiliser la plateforme à des fins illégales ou contraires aux bonnes mœurs.</p>
                    </section>
                    
                    <section>
                        <h2 class="text-2xl font-bold text-gray-800 mb-4">3. Responsabilités</h2>
                        <p class="text-gray-700">OBLINK ne peut être responsable de : les contenus fournis par les utilisateurs, les transactions entre utilisateurs, les dommages directs ou indirects résultant de l'utilisation de la plateforme.</p>
                    </section>
                    
                    <section>
                        <h2 class="text-2xl font-bold text-gray-800 mb-4">4. Données Personnelles</h2>
                        <p class="text-gray-700">Vos données personnelles sont traitées conformément à notre politique de confidentialité et à la loi RGPD. Consultez notre politique de confidentialité pour plus de détails.</p>
                    </section>
                    
                    <section>
                        <h2 class="text-2xl font-bold text-gray-800 mb-4">5. Modification des CGU</h2>
                        <p class="text-gray-700">OBLINK se réserve le droit de modifier ces conditions à tout moment. Les modifications seront publiées sur cette page avec la date de la dernière mise à jour.</p>
                    </section>
                    
                    <section>
                        <h2 class="text-2xl font-bold text-gray-800 mb-4">6. Contact</h2>
                        <p class="text-gray-700">Pour toute question, veuillez nous contacter à : contact@oblink.fr</p>
                    </section>
                </div>
                
                <div class="mt-8 text-center">
                    <p class="text-gray-600 text-sm">Dernière mise à jour : 19 janvier 2026</p>
                </div>
            </div>
        </div>
    </body>
...
app.get('/opticiens', (c) => {
  return c.html(`
    ...
    <head>
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>Pour les Opticiens - OBLINK</title>
        <script src="https://cdn.tailwindcss.com"></script>
        <link href="https://cdn.jsdelivr.net/npm/@fortawesome/fontawesome-free@6.4.0/css/all.min.css" rel="stylesheet">
        <link href="/static/styles.css" rel="stylesheet">
    </head>
    <body class="bg-gradient-to-br from-slate-50 via-blue-50 to-violet-50">
        ...
        <div class="max-w-4xl mx-auto px-4 py-32">
            <h1 class="text-5xl font-bold text-gray-800 mb-6">Pour les Opticiens Freelance</h1>
            <p class="text-xl text-gray-600 mb-12">Trouvez des missions à votre convenance et développez votre activité</p>
            
            <div class="glass-card p-8 space-y-6">
                <h2 class="text-2xl font-bold text-gray-800 mb-4">Avantages d'OBLINK</h2>
                <ul class="space-y-4">
                    <li class="flex items-start">
                        <i class="fas fa-check-circle text-oblink-orange mr-4 mt-1 text-xl"></i>
                        <div>
                            <h3 class="font-bold text-gray-800">Missions variées</h3>
                            <p class="text-gray-600">Accédez à des opportunités dans toute la France</p>
                        </div>
                    </li>
                    <li class="flex items-start">
                        <i class="fas fa-check-circle text-oblink-orange mr-4 mt-1 text-xl"></i>
                        <div>
                            <h3 class="font-bold text-gray-800">Flexibilité totale</h3>
                            <p class="text-gray-600">Choisissez vos missions selon votre disponibilité</p>
                        </div>
                    </li>
                    <li class="flex items-start">
                        <i class="fas fa-check-circle text-oblink-orange mr-4 mt-1 text-xl"></i>
                        <div>
                            <h3 class="font-bold text-gray-800">Rémunération équitable</h3>
                            <p class="text-gray-600">Tarifs transparents sans frais cachés</p>
                        </div>
                    </li>
                </ul>
                
                <a href="/register/opticien" class="inline-block px-8 py-4 bg-gradient-to-r from-oblink-orange to-oblink-violet text-white rounded-lg font-semibold hover:shadow-lg transition transform hover:scale-105">
...
app.get('/entreprises', (c) => {
  return c.html(`
    ...
    <head>
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>Pour les Entreprises - OBLINK</title>
        <script src="https://cdn.tailwindcss.com"></script>
        <link href="https://cdn.jsdelivr.net/npm/@fortawesome/fontawesome-free@6.4.0/css/all.min.css" rel="stylesheet">
        <link href="/static/styles.css" rel="stylesheet">
    </head>
    <body class="bg-gradient-to-br from-slate-50 via-blue-50 to-violet-50">
        ...
        <div class="max-w-4xl mx-auto px-4 py-32">
            <h1 class="text-5xl font-bold text-gray-800 mb-6">Pour les Entreprises Optiques</h1>
            <p class="text-xl text-gray-600 mb-12">Recrutez des opticiens qualifiés et vérifiés rapidement</p>
            
            <div class="glass-card p-8 space-y-6">
                <h2 class="text-2xl font-bold text-gray-800 mb-4">Avantages d'OBLINK</h2>
                <ul class="space-y-4">
                    <li class="flex items-start">
                        <i class="fas fa-check-circle text-oblink-violet mr-4 mt-1 text-xl"></i>
                        <div>
                            <h3 class="font-bold text-gray-800">Profils vérifiés</h3>
                            <p class="text-gray-600">Tous nos profils sont validés et authentifiés</p>
                        </div>
                    </li>
                    <li class="flex items-start">
                        <i class="fas fa-check-circle text-oblink-violet mr-4 mt-1 text-xl"></i>
                        <div>
                            <h3 class="font-bold text-gray-800">Recrutement rapide</h3>
                            <p class="text-gray-600">Trouvez le profil idéal en moins de 48h</p>
                        </div>
                    </li>
                    <li class="flex items-start">
                        <i class="fas fa-check-circle text-oblink-violet mr-4 mt-1 text-xl"></i>
                        <div>
                            <h3 class="font-bold text-gray-800">Solution scalable</h3>
                            <p class="text-gray-600">Pour une mission ou pour toute l'année</p>
                        </div>
                    </li>
                </ul>
                
                <a href="/register/entreprise" class="inline-block px-8 py-4 bg-gradient-to-r from-oblink-orange to-oblink-violet text-white rounded-lg font-semibold hover:shadow-lg transition transform hover:scale-105">
                    S'inscrire maintenant
                </a>
            </div>
        </div>
...
app.get('/faq', (c) => {
  return c.html(`
    ...
    <body class="bg-gradient-to-br from-slate-50 via-blue-50 to-violet-50">
        ...
        <div class="max-w-4xl mx-auto px-4 py-32">
            <h1 class="text-5xl font-bold text-gray-800 mb-12">Questions Fréquemment Posées</h1>
            
            <div class="space-y-6">
                <div class="glass-card p-8">
                    <h3 class="text-xl font-bold text-gray-800 mb-3">Comment fonctionne OBLINK ?</h3>
                    <p class="text-gray-700">OBLINK met en relation opticiens freelance avec entreprises optiques. Inscrivez-vous, complétez votre profil, et commencez à découvrir des missions adaptées à vos compétences.</p>
                </div>
                
                <div class="glass-card p-8">
                    <h3 class="text-xl font-bold text-gray-800 mb-3">Quels sont les frais ?</h3>
                    <p class="text-gray-700">Aucun frais d'inscription ! Les entreprises paient une commission sur les missions finalisées.</p>
                </div>
                
                <div class="glass-card p-8">
                    <h3 class="text-xl font-bold text-gray-800 mb-3">Comment se faire payer ?</h3>
                    <p class="text-gray-700">Les paiements se font directement entre opticien et entreprise. OBLINK facilite la mise en relation mais ne gère pas les transactions.</p>
                </div>
                
                <div class="glass-card p-8">
                    <h3 class="text-xl font-bold text-gray-800 mb-3">Est-ce que je dois accepter toutes les missions ?</h3>
                    <p class="text-gray-700">Non, vous avez la liberté de choisir les missions qui correspondent à vos besoins et votre disponibilité.</p>
                </div>
            </div>
            
            <p class="text-center mt-12 text-gray-600">
                D'autres questions ? <a href="/contact" class="text-oblink-orange font-semibold hover:underline">Contactez-nous</a>
            </p>
        </div>
    </body>
    </html>
  ...
  return c.html(`
    ...
    <body class="bg-gradient-to-br from-slate-50 via-blue-50 to-violet-50">
        ...
        <div class="max-w-2xl mx-auto px-4 py-32">
            ...
            <p class="text-xl text-gray-600 mb-12">Nous sommes là pour vous aider</p>
            ...
            <div class="glass-card p-8">
                <form class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea rows="6" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-oblink-orange focus:border-transparent" required></textarea>
                    </div>
            ...
            <div class="grid md:grid-cols-2 gap-6 mt-12">
                <div class="text-center">
                    <div class="text-4xl text-oblink-orange mb-3">
                        <i class="fas fa-envelope"></i>
                    </div>
                    <p class="text-gray-600">Email : contact@oblink.fr</p>
                </div>
                <div class="text-center">
                    <div class="text-4xl text-oblink-orange mb-3">
...
// Mentions légales (alias for /legal)
...
app.get('/legal', (c) => {
  return c.html(`
    ...
    <head>
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>Mentions Légales - OBLINK</title>
        <script src="https://cdn.tailwindcss.com"></script>
        <link href="https://cdn.jsdelivr.net/npm/@fortawesome/fontawesome-free@6.4.0/css/all.min.css" rel="stylesheet">
        <link href="/static/styles.css" rel="stylesheet">
    </head>
    <body class="bg-gradient-to-br from-slate-50 via-blue-50 to-violet-50">
        ...
        <div class="max-w-4xl mx-auto px-4 py-32">
            <h1 class="text-5xl font-bold text-gray-800 mb-8">Mentions Légales</h1>
            
            <div class="glass-card p-8 space-y-6">
                <section>
                    <h2 class="text-2xl font-bold text-gray-800 mb-4">Éditeur du site</h2>
                    <p class="text-gray-700">
                        OBLINK<br>
                        Plateforme de mise en relation<br>
                        France<br>
                ...
                <section>
                    <h2 class="text-2xl font-bold text-gray-800 mb-4">Hébergement</h2>
                    <p class="text-gray-700">
                        Ce site est hébergé sur Cloudflare Pages.<br>
                        Contact : www.cloudflare.com
                    </p>
                </section>
                
                <section>
                    <h2 class="text-2xl font-bold text-gray-800 mb-4">Propriété intellectuelle</h2>
                    <p class="text-gray-700">
                        Tous les éléments du site (contenus, design, logos) sont la propriété exclusive d'OBLINK et protégés par les lois sur la propriété intellectuelle.
                    </p>
                </section>
                
                <section>
                    <h2 class="text-2xl font-bold text-gray-800 mb-4">Responsabilité</h2>
                    <p class="text-gray-700">
                        OBLINK décline toute responsabilité quant aux contenus externes et aux informations fournies par les utilisateurs.
                    </p>
                </section>
                
                <section>
                    <h2 class="text-2xl font-bold text-gray-800 mb-4">Données personnelles</h2>
                    <p class="text-gray-700">
                        Vos données sont traitées conformément à la loi RGPD. Consultez notre politique de confidentialité pour plus d'informations.
                    </p>
                </section>
            </div>
        </div>
...
app.get('/politique-confidentialite', (c) => {
  return c.html(`
    <!DOCTYPE html>
    <html lang="fr">
    <head>
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>Politique de Confidentialité - OBLINK</title>
        <script src="https://cdn.tailwindcss.com"></script>
        <link href="https://cdn.jsdelivr.net/npm/@fortawesome/fontawesome-free@6.4.0/css/all.min.css" rel="stylesheet">
        <link href="/static/styles.css" rel="stylesheet">
    </head>
    <body class="bg-gradient-to-br from-slate-50 via-blue-50 to-violet-50">
        ...
        <div class="max-w-4xl mx-auto px-4 py-32">
            <h1 class="text-5xl font-bold text-gray-800 mb-8">Politique de Confidentialité</h1>
            
            <div class="glass-card p-8 space-y-6">
                <section>
                    <h2 class="text-2xl font-bold text-gray-800 mb-4">Collecte de données</h2>
                    <p class="text-gray-700">
                        OBLINK collecte uniquement les données nécessaires au fonctionnement de la plateforme : email, nom, prénom, informations professionnelles.
                    </p>
                </section>
                
                <section>
                    <h2 class="text-2xl font-bold text-gray-800 mb-4">Utilisation des données</h2>
                    <p class="text-gray-700">
                        Vos données sont utilisées pour mettre en relation les opticiens et entreprises, ainsi que pour améliorer nos services.
                    </p>
                </section>
                
                <section>
                    <h2 class="text-2xl font-bold text-gray-800 mb-4">Protection des données</h2>
                    <p class="text-gray-700">
                ...
                <section>
                    ...
                    <p class="text-gray-700">
                        Vous disposez du droit d'accès, de rectification, de suppression et de portabilité de vos données. Contactez-nous à contact@oblink.fr pour exercer ces droits.
                    </p>
                </section>
            </div>
        </div>
