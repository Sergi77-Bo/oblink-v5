    ...
    <div class="max-w-7xl mx-auto px-4 mb-12">
        <div class="text-center mb-8">
            ...
            <p class="text-lg text-oblink-gray/70 max-w-2xl mx-auto">
                Découvrez notre modèle économique en 3 piliers : Abonnements B2B, Formations B2C, et Services
                Partenaires
            </p>
        </div>
        ...
        <div class="flex flex-wrap justify-center gap-3 mb-12">
            ...
            <button
                ...
                data-category="b2b">
                <i class="fas fa-building mr-2"></i>B2B - Magasins
            </button>
            <button
                class="filter-btn bg-white/60 backdrop-blur-xl border border-white/40 text-oblink-gray px-6 py-3 rounded-xl font-bold transition hover:shadow-lg"
                data-category="b2c">
                <i class="fas fa-graduation-cap mr-2"></i>B2C - Formation
            </button>
            <button
                class="filter-btn bg-white/60 backdrop-blur-xl border border-white/40 text-oblink-gray px-6 py-3 rounded-xl font-bold transition hover:shadow-lg"
    ...
    <div class="max-w-7xl mx-auto px-4">
        <div id="products-grid" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="product-card bg-white/80 backdrop-blur-xl rounded-2xl overflow-hidden border border-white/50 shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-105"
                ...
                <div class="p-6">
                    <span
                        class="inline-block px-3 py-1 bg-oblink-blue/10 text-oblink-blue text-xs font-bold rounded-full mb-3">B2B
                        - Magasins</span>
                    <h3 class="text-xl font-bold text-oblink-gray mb-2">Abonnement Premium</h3>
                    <p class="text-sm text-gray-600 mb-4">Offres illimitées, CV-thèque complète, Badge Recruteur Vérifié
                    </p>
            ...
            <div class="product-card bg-white/80 backdrop-blur-xl rounded-2xl overflow-hidden border border-white/50 shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-105"
                ...
                <div class="p-6">
                    <span
                        class="inline-block px-3 py-1 bg-oblink-violet/10 text-oblink-violet text-xs font-bold rounded-full mb-3">B2B
                        - Corporate</span>
                    <h3 class="text-xl font-bold text-oblink-gray mb-2">Offre Corporate</h3>
                    <p class="text-sm text-gray-600 mb-4">API RH, Facturation centralisée, Gestion multi-comptes</p>
                    <div class="flex items-baseline gap-2 mb-4">
            ...
            <div class="product-card bg-white/80 backdrop-blur-xl rounded-2xl overflow-hidden border border-white/50 shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-105"
                ...
                <div class="p-6">
                    <span
                        class="inline-block px-3 py-1 bg-oblink-orange/10 text-oblink-orange text-xs font-bold rounded-full mb-3">B2C
                        - Formation</span>
                    <h3 class="text-xl font-bold text-oblink-gray mb-2">Pass Examen BTS</h3>
                    <p class="text-sm text-gray-600 mb-4">Annales corrigées (27 ans) + Chatbot Tuteur IA illimité</p>
                    <div class="flex items-baseline gap-2 mb-4">
            ...
            <div class="product-card bg-white/80 backdrop-blur-xl rounded-2xl overflow-hidden border border-white/50 shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-105"
                ...
                <div class="p-6">
                    <span
                        class="inline-block px-3 py-1 bg-indigo-100 text-indigo-600 text-xs font-bold rounded-full mb-3">B2C
                        - VAE</span>
                    <h3 class="text-xl font-bold text-oblink-gray mb-2">Pack Réussite VAE</h3>
                    <p class="text-sm text-gray-600 mb-4">Aide rédaction Livret 2 (IA) + Préparation Jury</p>
                    <div class="flex items-baseline gap-2 mb-4">
            ...
            <div class="product-card bg-white/80 backdrop-blur-xl rounded-2xl overflow-hidden border border-white/50 shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-105"
                ...
                <div class="p-6">
                    <span
                        class="inline-block px-3 py-1 bg-green-100 text-green-600 text-xs font-bold rounded-full mb-3">B2C
                        - Certification</span>
                    <h3 class="text-xl font-bold text-oblink-gray mb-2">Certification Logiciel</h3>
                    <p class="text-sm text-gray-600 mb-4">Test de compétence (Cosium, etc.) + Badge Certifié</p>
                    <div class="flex items-baseline gap-2 mb-4">
            ...
            <div class="product-card bg-white/80 backdrop-blur-xl rounded-2xl overflow-hidden border border-white/50 shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-105"
                ...
                <div class="p-6">
                    <span
                        class="inline-block px-3 py-1 bg-gray-200 text-gray-700 text-xs font-bold rounded-full mb-3">Partenaires</span>
                    <h3 class="text-xl font-bold text-oblink-gray mb-2">Services Partenaires</h3>
                    <p class="text-sm text-gray-600 mb-4">Compte Pro, Assurance RC, Compta, Création Société</p>
                    <div class="flex items-baseline gap-2 mb-4">
