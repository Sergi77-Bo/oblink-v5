<?php
/*
Template Name: Académie Oblink (Marketplace V2)
*/
get_header();
?>
...
<div class="min-h-screen bg-gradient-to-br from-gray-50 via-violet-50/30 to-orange-50/20 pt-28 pb-20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-12">
            ...
            <!-- Navigation Switch (NEW) -->
            <div class="flex items-center justify-center gap-4">
                <a href="<?php echo home_url('/pass-examen'); ?>"
                    class="px-6 py-3 rounded-xl bg-white text-oblink-gray font-bold border border-gray-200 hover:bg-gray-50 hover:border-oblink-orange hover:text-oblink-orange transition shadow-sm flex items-center gap-2">
                    <i class="fas fa-user-graduate"></i>
                    Je passe mon BTS
                </a>
                <span
                    class="px-6 py-3 rounded-xl bg-oblink-violet text-white font-bold shadow-lg flex items-center gap-2 ring-4 ring-violet-100">
                    <i class="fas fa-laptop-medical"></i>
                    Catalogue Formations Pro
                </span>
            </div>
        </div>
