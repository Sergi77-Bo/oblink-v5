        ...
        <div class="text-center max-w-4xl mx-auto">
            ...
            <div class="flex flex-col sm:flex-row justify-center gap-4">
                ...
                <a href="<?php echo home_url('/recherche-opticiens'); ?>"
                    ...
                    <i class="fas fa-search text-oblink-blue"></i> Voir les profils disponibles
                </a>
            </div>

            <!-- Compatible With Section (Faux Logos for Demo) -->
            <div class="mt-16 pt-8 border-t border-gray-100">
                <p class="text-sm text-gray-400 uppercase tracking-widest font-bold mb-6">Compatible avec vos outils</p>
                <div
                    class="flex flex-wrap justify-center gap-8 md:gap-16 opacity-50 grayscale hover:grayscale-0 transition duration-500">
                    <!-- Text/Icon Placeholders that look like logos -->
                    <div class="flex items-center gap-2 text-xl font-bold font-display text-gray-600">
                        <i class="fas fa-desktop text-oblink-blue"></i> Cosium
                    </div>
                    <div class="flex items-center gap-2 text-xl font-bold font-display text-gray-600">
                        <i class="fas fa-eye text-oblink-orange"></i> Ivoirnet
                    </div>
                    <div class="flex items-center gap-2 text-xl font-bold font-display text-gray-600">
                        <i class="fas fa-glasses text-oblink-violet"></i> Ophtix
                    </div>
                    <div class="flex items-center gap-2 text-xl font-bold font-display text-gray-600">
                        <i class="fas fa-server text-gray-500"></i> Odoo
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid md:grid-cols-3 gap-8 mb-12">
                ...
                <div
                    ...
                    <!-- Academy Plug -->
                    <div
                        class="bg-oblink-violet/5 rounded-lg p-3 border border-oblink-violet/10 flex items-start gap-3">
                        <i class="fas fa-certificate text-oblink-violet mt-1"></i>
                        <p class="text-xs text-oblink-gray">
                            <strong>Le seul vivier certifié :</strong> Nous validons la maîtrise de vos logiciels
                            (Cosium, Ivoirnet) via l'Académie OBLINK.
                        </p>
                    </div>
                </div>
